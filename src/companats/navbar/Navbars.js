  ...
  <header>
    ...
    <div className='nav' ref={menubar}>
      ...
      <ul className='ul shadow'>
        ...
        <li><Link to='/faqs'className='link'>Faq's</Link></li>
        <li><Link to='/booking'className='link'>Booking</Link></li>
        <li><Link to='/notfound'className='link'>Error 404</Link></li>
      ...
      <ul className='ul shadow'>
        ...
        <li><Link to='/servicedetail'className='link'>service details</Link></li>
      </ul>
      </Link>
